...
<nav class="navbar sticky-top navbar-expand-lg navbar-dark" id="nav">
    ...
    <div class="collapse navbar-collapse flex-grow-0" id="nav-buttons">
        <ul class="navbar-nav">
            <li class="nav-item"><a class="nav-link" href="{{ route('actionMainIndex') }}"><span>მთავარი გვერდი</span></a></li>
            <li class="nav-item">
...
<script src="{{ asset('vendor/laravel-filemanager/js/jquery.min.js') }}"></script>
